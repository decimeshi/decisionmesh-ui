...
const ARTICLES = [
  ...
  {
    slug: 'ai-governance-enterprise-infrastructure',
    title: 'AI Governance Infrastructure for the Enterprise',
    description: 'How to build the technical foundation for AI governance — audit trails, policy engines, intent classification, and compliance reporting at enterprise scale.',
    category: 'Engineering',
  ...
  {
    slug: 'intent-based-ai-control-plane',
    title: 'The Intent-Based AI Control Plane: A New Architecture for LLM Governance',
    description: 'Why traditional API proxies fail for AI governance and how an intent-based control plane gives compliance teams real visibility and control over every AI decision.',
    category: 'Engineering',
